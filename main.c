...
SDL_AppIterate (void *appstate)
{
	...
	// you have to draw the whole window every frame,
	// clear whole window to fade color
	// to makes sure the whole thing is sane
...
SDL_AppEvent (void *appstate, SDL_Event *event)
{
	switch (event->type) {
	case SDL_EVENT_QUIT:
		// triggers on last window close and other things,
		// end the program
...
{
	SDL_SetAppMetadata("SDL Hello World Example", "0.1.0",
	...
	if (!SDL_CreateWindowAndRenderer("Hello SDL", 640, 480,
